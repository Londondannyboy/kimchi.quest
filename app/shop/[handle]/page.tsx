...
const demoProducts: Record<string, {
  ...
  'spicy-kimchi': {
    ...
    descriptionHtml: '<p>Extra kick for those who like it hot. Same great fermentation, more heat.</p><p>Made with additional gochugaru and fresh chillies for those who crave the burn.</p>',
    price: '9.00',
  ...
  'mild-kimchi': {
    ...
    descriptionHtml: '<p>All the probiotic benefits with a gentler spice level.</p><p>Perfect for beginners or those who prefer less heat but still want authentic kimchi flavour.</p>',
    price: '8.50',
  ...
  'vegan-kimchi': {
    ...
    descriptionHtml: '<p>Traditional flavour without fish sauce.</p><p>100% plant-based fermentation using kelp and miso for umami depth. All the probiotics, completely vegan.</p>',
    price: '9.00',
