          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl shadow-sm p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-kimchi-red/10 rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="ml-4">
                    ...
                    <a
                      ...
                      className="text-kimchi-red hover:underline"
                    >
                ...
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-kimchi-red/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-kimchi-red" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-kimchi-red rounded-2xl shadow-sm p-8 text-white">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 bg-white text-kimchi-red font-semibold rounded-full hover:bg-gray-100 transition-colors"
              >
