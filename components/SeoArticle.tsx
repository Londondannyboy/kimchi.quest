      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          ...
          <div className="flex gap-4">
            <a
              href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(article.title)}&url=${encodeURIComponent(`https://kimchi.quest/${article.slug}`)}`}
              target="_blank"
            ...
            <a
              href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://kimchi.quest/${article.slug}`)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-kimchi-red transition-colors"
            ...
            <a
              href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(`https://kimchi.quest/${article.slug}`)}&title=${encodeURIComponent(article.title)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-kimchi-red transition-colors"
